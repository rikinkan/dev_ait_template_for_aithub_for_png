...
if not is_ait_launch:
    ...
    manifest_genenerator.set_ait_name('dev_ait_template_for_aithub_png')
    manifest_genenerator.set_ait_description('AIT開発テンプレート(AIT-HUB登録用)')
    manifest_genenerator.set_ait_source_repository('https://github.com/aistairc/qunomon/tree/main/ait_repository/ait/dev_ait_template_for_aithub_png')
